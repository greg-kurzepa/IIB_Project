...
layer1 = _pile_and_soil.SandLayer(gamma_d_l[0], e=0.689, N_q=8, beta=beta_l[0], shaft_friction_limit=47.8e3, end_bearing_limit=1.9e6, base_depth=12.5)
layer2 = _pile_and_soil.SandLayer(gamma_d_l[0], e=0.441, N_q=40, beta=beta_l[1], shaft_friction_limit=96e3, end_bearing_limit=10e6, base_depth=pile.L)
soil = _pile_and_soil.Soil([layer1, layer2])

res = _model_springs.solve_springs4(pile, soil, P, 3, N, nondim=True)
