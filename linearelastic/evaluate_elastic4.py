...
ax[0].plot(z, F_analytic, label='analytic')
ax[0].plot(z, F_springs, label='springs', linestyle="--")
ax[0].set_xlabel('z (m)')
ax[0].set_ylabel('F (N)')
# ax[0].title(f"F_analytic vs F_springs, L_over_D = {L_over_D}")
...
ax[1].plot(z, F_analytic, label='analytic')
ax[1].plot(z, F_springs, label='springs', linestyle="--")
ax[1].set_xlabel('z (m)')
ax[1].set_ylabel('F (N)')
