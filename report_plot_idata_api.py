...
api_idata_1 = cloudpickle.load(open("results\\api_idata_1.pkl", "rb"))
api_idata_2 = cloudpickle.load(open("results\\api_idata_2.pkl", "rb"))
sf = 1000
...
ax[0].hist(prior_gamma_1, density=True, bins=50, alpha=0.5, label="prior")
ax[0].hist(posterior_gamma_1, density=True, bins=50, alpha=0.5, label="posterior")
ax[0].get_yaxis().set_visible(False)
ax[0].set_xlabel("$\\gamma_d$, Top Layer, kN/m")
ax[0].legend()

ax[1].hist(prior_gamma_2, density=True, bins=50, alpha=0.5, label="prior")
...
for row, subfig in enumerate(subfigs):
    ...
    ax[0].hist(prior_gamma_1 if row==0 else prior_gamma_1_idat2, density=True, bins=50, alpha=0.5, label="prior samples")
    ...
    ax[1].hist(prior_gamma_2 if row==0 else prior_gamma_2_idat2, density=True, bins=50, alpha=0.5, label="prior samples")
